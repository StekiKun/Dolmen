...
public final class JLEParser extends codegen.BaseParser<JLEParser.Token> {
    ...
    public <T extends codegen.LexBuffer> JLEParser(T lexbuf, java.util.function.Function<T, Token> tokens) {
        super(lexbuf, tokens);
    }
    ...
    public  Lexer  lexer() {
		...
		Lexer.Builder builder =
			new Lexer.Builder(imports, header, definitions, footer);
