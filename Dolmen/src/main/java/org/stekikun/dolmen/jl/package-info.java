 ...
 * constructed and provided declaratively in {@link org.stekikun.dolmen.jl.JLLexer}
 * instead of being described in .jl syntax. That class'
 * {@link org.stekikun.dolmen.jl.JLLexer#main(String[])} method can then be used
 * to turn that declarative grammar description into the
 * actual parser {@link org.stekikun.dolmen.jl.JLLexerGenerated}.
 * <p>
 * The parser for simple lexer descriptions is simply
 * written manually as a top-down parser, in {@link org.stekikun.dolmen.jl.JLParser}.
 * The flow and principle follows the one of a Dolmen-generated
 * parser, and the actual BNF grammar is included in Javadoc.
 * <p>
 * <i>NB: The process of generating {@link org.stekikun.dolmen.jl.JLLexerGenerated} 
 * is automated by the target {@code jllexer} of 
 * the {@code build.xml} ANT script.</i>
 */
@org.eclipse.jdt.annotation.NonNullByDefault package org.stekikun.dolmen.jl;