 ...
 * 'JLEParser.jg' description file.
 *  
 * @author Stéphane Lescuyer
 */
public abstract class JLEParserStub {

	private JLEParserStub() {
		// Static utility only
	}
	...
	public static void main(String[] args) throws IOException {
		generateParser("src/org/stekikun/dolmen/jle/JLEParser.jg", "JLEParser", false);
	}
}