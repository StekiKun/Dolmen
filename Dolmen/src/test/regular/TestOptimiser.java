...
public final class TestOptimiser
	...
	private static Object decodeTagAddr(String input, 
		...
		case TagAddr.END: base = input.length() - 1; break;
		default: {
