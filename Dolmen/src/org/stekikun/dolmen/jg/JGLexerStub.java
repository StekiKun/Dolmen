...
public abstract class JGLexerStub {
	...
	static void generateLexer(String filename, String className) throws IOException {
		...
		File file = new File("src/org/stekikun/dolmen/jg/" + className + ".java");
		try (FileWriter writer = new FileWriter(file, false)) {
			writer.append("package org.stekikun.dolmen.jg;\n");
	...
	public static void main(String[] args) throws IOException {
		generateLexer("src/org/stekikun/dolmen/jg/JGLexer.jl", "JGLexer");
	}
}
